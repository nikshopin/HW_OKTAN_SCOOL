...
let convertCurrencyFromTo = (cash: number, objCurrency1: {currency: string, value: number}, objCurrency2: {currency: string, value: number}, currencyReturn: string): number => {
