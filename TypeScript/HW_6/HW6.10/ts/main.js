...
let blackCards = cards.filter((value) => { return value.cardSuit === 'clubs' || value.cardSuit === 'spade'; }).map((value) => (Object.assign(Object.assign({}, value), { color: 'black' })));
let redCards = cards.filter((value) => value.cardSuit === 'heart' || value.cardSuit === 'diamond').map((value) => (Object.assign(Object.assign({}, value), { color: 'red' })));
...
let fivethTask = fullCards.filter((value) => value.cardSuit === 'clubs' && (typeof value.value === 'string' || value.value > 8));
