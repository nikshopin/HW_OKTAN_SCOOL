...
let arr: {id:number, name: string, surname: string, email: string, phone: string}[] = [];
...
let sortUsers:{id:number, name: string, surname: string, email: string, phone: string}[] = arr.sort((a: {id:number, name: string, surname: string, email: string, phone: string} , b:{id:number, name: string, surname: string, email: string, phone: string}): number => a.id < b.id ? 1 : a.id === b.id ? 0 : -1);
