function Client (id: number, name: string, surname: string, email: string, phone: string, order: string[]): {id: number, name: string, surname: string, email: string, phone: string, order: string[]} {
    // this.id = id;
    // this.name = name;
...
let client: {id: number, name: string, surname: string, email: string, phone: string, order: string[]}[] = [
...
let sortArr: {id: number, name: string, surname: string, email: string, phone: string, order: string[]}[] = client.sort((a:{id: number, name: string, surname: string, email: string, phone: string, order: string[]}, b:{id: number, name: string, surname: string, email: string, phone: string, order: string[]}): number => {return a.order.length > b.order.length? 1 :a.order.length === b.order.length ? 0 : -1 ;});
console.log(sortArr);